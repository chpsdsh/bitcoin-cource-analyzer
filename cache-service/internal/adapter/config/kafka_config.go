...
var (
	...
	ErrKafkaInputNewsTopicNotSet     = errors.New("kafka input topic should be set with KAFKA_ARTICLES_TOPIC env variable")
	ErrKafkaGroupNotSet              = errors.New("kafka group should be set with KAFKA_GROUP_ID env variable")
	ErrKafkaInputArticlesTopicNotSet = errors.New("kafka input topic should be set with KAFKA_NEWS_TOPIC env variable")
)
